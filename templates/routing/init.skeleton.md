...
<!-- REGION:command — forge CLI discovery belongs to command surfaces -->
<!-- SPLICE:in-cmd-001 -->
...
<!-- /REGION -->
<!-- REGION:skill — the native skill also records its installed claim carrier -->
<!-- SPLICE:in-sk-001 -->
