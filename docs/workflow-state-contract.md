...
not a fallback. The Finalization-phase mechanical bookkeeping is likewise main-session-direct: it
is one `cmdFinalize` transaction the orchestrator runs, with no dispatched role and no separate
attestation (issue #816).
