...
function refreshPresentEditionTrees() {
  ...
  let failed = 0;
  for (const script of ['sync-opencode-edition.js', 'sync-kimi-edition.js', 'sync-grok-edition.js', 'sync-cursor-edition.js', 'sync-zcode-edition.js', 'sync-devin-edition.js']) {
