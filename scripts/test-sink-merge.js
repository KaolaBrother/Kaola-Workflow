...
(function testCollisionSuffixedArchiveCommittedAndDisposed() {
  ...
  try {
    ...
    // The roadmap-source-removal + regenerated-mirror assertions stood here. ADR 0018 §5 retired
    // archiveProjectDir's roadmap-source unlink and mirror regeneration — there is no local roadmap
    // source or mirror left for this sink to update. Deleted with the mechanism.
...
// Tests (e)/(f)/(g) #705 stood here: keep-open roadmap-source retention (survival on a
// keep-open sink, removal on a closing sink, and per-member excludeIssues scoping in a mixed
// bundle). ADR 0018 §5 retired archiveProjectDir's roadmap-source unlink/retain entirely — there
// is no local roadmap source or mirror left for a closure to remove, keep, or scope. Deleted
// with the mechanism.
