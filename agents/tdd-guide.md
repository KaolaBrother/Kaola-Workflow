...
- a **`GREEN`** line: the same test passing AFTER the minimal implementation (+ a one-line count
  of assertions/tests now green).

Example evidence block:
```
RED: test_widget_rejects_empty — AssertionError: expected throw, got undefined (pre-impl)
