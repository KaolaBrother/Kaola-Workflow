...
// ---------------------------------------------------------------------------
// kaola-gitea-workflow-gap-sweep.js (issue #435 — run-gap capture gate)
//
...
//
// Usage:
//   node kaola-gitea-workflow-gap-sweep.js --project <name> [options]
//
// Subcommands / modes:
  ...
  for (let i = 0; i < args.length; i++) {
    ...
    if (a === '--project') {
      ...
      process.stdout.write(
        'Usage: kaola-gitea-workflow-gap-sweep.js --project <name> [--json] [--check]\n' +
