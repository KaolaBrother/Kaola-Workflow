...
assert(agentFiles.length === 16, 'expected 16 Gitea agent profiles (13 base + synthesizer #463 + metric-optimizer #634; <role>-max retired #451, issue-scout retired #789), got ' + agentFiles.length);
