...
// run()/execFileSync (no env override, so they inherit this process.env): test-gitea-workflow-scripts.js,
// test-gitea-sinks.js, and the inline bundle-426-428 spawns. claim.js reads the HOME
