...
```bash
preflight_script="plugins/kaola-workflow/scripts/kaola-workflow-codex-preflight.js"
if [ ! -f "$preflight_script" ]; then
  preflight_script="$(find "$HOME/.codex/plugins/cache" -path '*/kaola-workflow/*/scripts/kaola-workflow-codex-preflight.js' -print -quit 2>/dev/null)"
fi
