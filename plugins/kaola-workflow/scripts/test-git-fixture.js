...
// one-caller helper.
//
// Usage — ALWAYS the tree-local copy
//   const G = require('./test-git-fixture');
// Every forge contract validator forbids a parent-directory require anywhere in its scripts
// tree ("must not fall back to root or GitHub plugin scripts"), and it matches on raw text,
// comments included. So each edition tree carries its own byte-identical copy, held in step
// by the `git-fixture module copies` group in scripts/validate-script-sync.js. Never reach
// across trees, not even in an example.
