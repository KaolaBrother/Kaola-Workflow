...
owned by the fast transaction script `kaola-gitlab-workflow-fast-advance.js`. The script
...
KAOLA_SCRIPTS="$(dirname "$(kaola_script kaola-gitlab-workflow-fast-advance.js)")"
```
