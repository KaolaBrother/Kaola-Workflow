...
// ---------------------------------------------------------------------------
// kaola-gitlab-workflow-next-action.js (issue #242)
//
...
//
// argv: node kaola-gitlab-workflow-next-action.js <plan-path> --json
//
// JSON output schema:
...
function main() {
  ...
  if (!args.length || args[0] === '--help' || args[0] === '-h') {
    process.stdout.write(
      'usage: kaola-gitlab-workflow-next-action.js <plan-path> --json\n' +
