...
function testInstallSchemaPruneManifest332Gitlab() {
  ...
  try {
    ...
    assert.strictEqual(tomls.length, 15, '#463 gl AC: fresh install must place 15 *.toml (14 base + synthesizer + metric-optimizer; <role>-max retired, issue-scout retired #789, investigator added #798)');
    ...
    assert.strictEqual(manifest.roles.length, 15, '#463 gl AC: manifest must list 15 roles (14 base + synthesizer + metric-optimizer)');
