...
- Claude Code command install, GitHub edition: `10.1.1`
- Claude Code command install, GitLab edition: `10.1.1`
- Claude Code command install, Gitea edition: `10.1.1`
- Codex `kaola-workflow` plugin manifest: `10.1.1`
- Codex `kaola-workflow-gitlab` plugin manifest: `10.1.1`
- Codex `kaola-workflow-gitea` plugin manifest: `10.1.1`
