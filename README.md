...
- Claude Code command install, GitHub edition: `9.8.0`
- Claude Code command install, GitLab edition: `9.8.0`
- Claude Code command install, Gitea edition: `9.8.0`
- Codex `kaola-workflow` plugin manifest: `7.8.0`
- Codex `kaola-workflow-gitlab` plugin manifest: `7.8.0`
- Codex `kaola-workflow-gitea` plugin manifest: `7.8.0`
