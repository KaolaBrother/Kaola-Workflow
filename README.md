...
- Claude Code command install, GitHub edition: `9.5.4`
- Claude Code command install, GitLab edition: `9.5.4`
- Claude Code command install, Gitea edition: `9.5.4`
- Codex `kaola-workflow` plugin manifest: `7.5.4`
- Codex `kaola-workflow-gitlab` plugin manifest: `7.5.4`
- Codex `kaola-workflow-gitea` plugin manifest: `7.5.4`
