...
- Claude Code command install, GitHub edition: `6.20.1`
- Claude Code command install, GitLab edition: `6.20.1`
- Claude Code command install, Gitea edition: `6.20.1`
- Codex `kaola-workflow` plugin manifest: `4.20.1`
- Codex `kaola-workflow-gitlab` plugin manifest: `4.20.1`
- Codex `kaola-workflow-gitea` plugin manifest: `4.20.1`
