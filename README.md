...
- Claude Code command install, GitHub edition: `5.4.1`
- Claude Code command install, GitLab edition: `5.4.1`
- Claude Code command install, Gitea edition: `5.4.1`
- Codex `kaola-workflow` plugin manifest: `3.4.1`
- Codex `kaola-workflow-gitlab` plugin manifest: `3.4.1`
- Codex `kaola-workflow-gitea` plugin manifest: `3.4.1`
