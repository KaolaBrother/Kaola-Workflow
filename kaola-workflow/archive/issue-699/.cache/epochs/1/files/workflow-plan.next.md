...
| id | status |
| --- | --- |
| r1-repair-blueprint | pending |
| r2-lifecycle-transport-repair | pending |
| r3-lineage-proof-repair | pending |
| r4-forge-contract-repair | pending |
| r5-documentation-correction | pending |
