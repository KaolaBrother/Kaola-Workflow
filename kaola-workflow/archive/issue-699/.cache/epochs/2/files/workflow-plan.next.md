...
| id | status |
| --- | --- |
| e1-epoch3-authority-blueprint | pending |
| e2-versioned-epoch-repair | pending |
| e3-lifecycle-publication-repair | pending |
...
|-------------|--------|----------|-------------|
| code-architect (e1-epoch3-authority-blueprint) | pending | | |
| tdd-guide (e2-versioned-epoch-repair) | pending | | |
