...
|-------------|--------|----------|-------------|
| implementer (n1-hook-pin-repair) | pending | | |
| code-reviewer (n2-code-certify) | pending | | |
| security-reviewer (n3-security-certify) | pending | | |
...
| id | status |
| --- | --- |
| n1-hook-pin-repair | pending |
| n2-code-certify | pending |
| n3-security-certify | pending |
| n4-finalize | pending |
