# Final Validation — issue-287 (Phase 6, finalize node)

Command: npm test (full suite, all four editions) — run from worktree /Volumes/WorkspaceA/ylminiserver/workspace/kaola-workflow/.kw/worktrees/issue-287
Date: 2026-06-08

```

> kaola-workflow@5.7.0 test
...
commit-node tests passed (32 assertions)
...
> kaola-workflow@5.7.0 test:kaola-workflow:codex
...
> kaola-workflow@5.7.0 test:kaola-workflow:gitlab
...
> kaola-workflow@5.7.0 test:kaola-workflow:gitea
