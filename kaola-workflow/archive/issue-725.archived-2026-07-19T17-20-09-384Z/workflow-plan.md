...
|-------------|--------|----------|-------------|
| tdd-guide (c1-scope-timeout-fix) | subagent-invoked | evidence-binding: c1-scope-timeout-fix 2b57aba7d890 | |
| code-reviewer (c2-code-review) | subagent-invoked | evidence-binding: c2-code-review 0917b8988cef | |
