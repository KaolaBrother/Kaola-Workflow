...
| id | status |
| --- | --- |
| r1-hook-assert-repair | pending |
| r2-code-certify | pending |
| r3-security-certify | pending |
| r4-finalize | pending |
...
|-------------|--------|----------|-------------|
| implementer (r1-hook-assert-repair) | pending | | |
| code-reviewer (r2-code-certify) | pending | | |
| security-reviewer (r3-security-certify) | pending | | |
| finalize (r4-finalize) | pending | | |
