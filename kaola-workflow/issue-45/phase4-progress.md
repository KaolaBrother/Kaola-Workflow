...
| 5 | P2-A: Flaw 2 — scanPhaseArtifacts conditional advance | pending | | |
| 6 | P2-B: Gap B — cmdSweep abandoned GC third pass | pending | | |
| 7 | P2-C: Gap C — cmdWorktreeStatus unregistered dirs | pending | | |
