...
Author a `workflow-plan.md` whose `## Nodes` table passes `kaola-workflow-plan-validator.js`, freeze
...
The planner RAN `kaola-workflow-adaptive-handoff.js` and returned a checklist-backed packet (plan
